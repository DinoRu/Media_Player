...
class Seekbar(tk.Canvas):
    ...
    def __init__(self, parent, **options):
        ...
        self.seekbar_knob_image = tk.PhotoImage(
            file="C:/Users/Moustapha/PycharmProjects/Media_Player/icons/seekbar_knob.gif")
...
class TestSeekBar:
    ...
    def __init__(self):
        ...
        c = Seekbar(frame, bg="blue", width=360, height=10)
